  ...
  return (
    <>
      ...
      >
        ...
        >
          <Text style={[styles.text, textColor, { flex: 2 }]}>Назва:</Text>
          <Input
            value={name}
            containerStyle={[{ flex: 5 }, styles.inputContainerStyle]}
        ...
        >
          <Text style={[styles.text, textColor, { flex: 2 }]}>Тип:</Text>
          <Input
            value={type}
            containerStyle={[{ flex: 5 }, styles.inputContainerStyle]}
            inputContainerStyle={{ borderBottomWidth: 0 }}
        ...
        >
          <Text style={[styles.text, textColor, { flex: 2 }]}>Об'єм:</Text>
          <Input
            keyboardType="numeric"
            value={volume}
            containerStyle={[{ flex: 3 }, styles.inputContainerStyle]}
            inputContainerStyle={{ borderBottomWidth: 0 }}
            inputStyle={styles.inputStyle}
            renderErrorMessage={false}
          ...
          />
          <Text
            style={[styles.text, textColor, { flex: 2, textAlign: "center" }]}
          >
            л
          </Text>
        </View>
        ...
        >
          <Text style={[styles.text, textColor, { flex: 2 }]}>Ціна:</Text>
          <Input
            keyboardType="numeric"
            value={price}
            containerStyle={[{ flex: 3 }, styles.inputContainerStyle]}
