...
const MenuItemDialog = ({
    ...
    const [activeForOrder, setActiveForOrder] = useState(
        menuItem.activeForOrder || true
    );
    ...
    const isValid = () => {
        ...
        if (name.length === 0 || name.length > maxCharactersLength)
            return false;
    ...
    return (
        <>
            <AlertDialog
                ...
                alertTitle={'Неправильно заповнено форму!'}></AlertDialog>
            <Dialog
                isVisible={isVisible}
                overlayStyle={[
                    styles.dialogWindow,
